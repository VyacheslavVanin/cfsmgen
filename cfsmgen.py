...
def add_generated_message(filedesc):
    filedesc.write('/*\n')
    filedesc.write(' *  This file was generated by cfsmgen script.\n')
    filedesc.write(' *  See www.github.com/VyacheslavVanin/cfmgen.git \n')
    filedesc.write(' */\n\n')
